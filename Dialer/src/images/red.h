#ifdef USE_RED_COLORS
const ULONG red_colors[12] =
{
...
#define RED_HEIGHT        7
#define RED_DEPTH         2
#define RED_COMPRESSION   1
#define RED_MASKING       2

#ifdef USE_RED_HEADER
const struct BitMapHeader red_header =
{ 7,7,0,0,2,2,1,0,0,22,22,640,480 };
#endif

#ifdef USE_RED_BODY
const UBYTE red_body[40] = {
